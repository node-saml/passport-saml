...
SAML.prototype.getLogoutUrl = function(req, callback) {
  ...
  this.requestToUrl(request, null, 'logout', {}, callback);
};
...
SAML.prototype.getLogoutResponseUrl = function(req, callback) {
  ...
  this.requestToUrl(null, response, 'logout', req.query && req.query.RelayState ? { RelayState: req.query.RelayState } : {}, callback);
};
