...
SAML.prototype.validatePostResponse = function (container, callback) {
  ...
  return this.validateXML(xml, null, callback);
};
...
//  var signature = new Buffer(container.Signature, 'base64').toString('ascii');
  ...
  zlib.inflateRaw(data, function(err, inflated) {
    ...
    self.validateXML(xml, "", callback);
  });
};

SAML.prototype.validateXML = function (xml, signature, callback) {
  var self = this;
