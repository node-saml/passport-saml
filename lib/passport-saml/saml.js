...
SAML.prototype.getElement = function (parentElement, elementName) {
  // once using xml2js 0.4.1+, can just use a tag name processor
  var namespacePrefixesToCheck = ['saml', 'samlp', 'saml2', 'saml2p'];
  for(var i=0; i < namespacePrefixesToCheck.length; i++ ) {
    var potentialElement = parentElement[namespacePrefixesToCheck[i] + ':' + elementName];
    if ( potentialElement )
