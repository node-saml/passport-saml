...
SAML.prototype.validatePostResponse = function (req, callback) {
  var xml = new Buffer(req.body.SAMLResponse, 'base64').toString('ascii');
  return this.validateXML(xml, callback);
};

SAML.prototype.validateRedirectResponse = function (req, callback) {
  var xml = new Buffer(req.body.SAMLResponse, 'base64').toString('ascii');
  return this.validateXML(xml, callback);
};

SAML.prototype.validateXML = function (xml, callback) {
  var self = this;
