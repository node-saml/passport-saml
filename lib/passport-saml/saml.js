...
SAML.prototype.generateAuthorizeRequest = function(opt, req) {
  ...
  var request =
    ...
    "\" ProtocolBinding=\"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST\" AssertionConsumerServiceURL=\"" + this.options.callbackUrl + "\" Destination=\"" + opt.entryPoint + "\">" +
    ...
    if (response) {
      ...
      if (attributes) {
        attributes.forEach(function(attribute) {
          ...
          if (opt.claimTranslations && opt.claimTranslations[name]) {
