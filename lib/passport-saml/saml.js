...
SAML.prototype.validateRedirectSignature = function (container) {
  var self = this;
  return Q.fcall(function () {
    ...
    var sign = signer.sign(self.options.privateCert, 'base64');
  ...
  zlib.inflateRaw(xml, function (err, data) {
    ...
    self.validateResponseInResponseTo(doc)
        .then(function (inResponseTo) {
          return Q.fcall(function () {
                  if(self.options.privateCert){
                      return self.validateRedirectSignature(container);
                  }
                  return true;
              })
            .then(function () {
