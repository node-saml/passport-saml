...
//          should.exist( err.statusXml );
    ...
    describe( 'getAuthorizeUrl request signature checks /', function() {
      ...
      it( 'acme_tools POST request signed with sha1', function( done ) {
        var samlConfig = {
      ...
      it( 'acme_tools POST request signed with sha256', function( done ) {
        var samlConfig = {
          entryPoint: 'https://adfs.acme_tools.com/adfs/ls/',
          issuer: 'acme_tools_com',
          callbackUrl: 'https://relyingparty/adfs/postResponse',
      ...
      it( 'acme_tools POST request signed with sha512', function( done ) {
        var samlConfig = {
          entryPoint: 'https://adfs.acme_tools.com/adfs/ls/',
          issuer: 'acme_tools_com',
          callbackUrl: 'https://relyingparty/adfs/postResponse',
